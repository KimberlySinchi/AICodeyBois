...
@Autonomous(name = "DEPOT Enemy Crater", group = "Slave")

public class DEPOTBOXenemycrater extends LinearOpMode
{
    ...
    private static final double SECONDS_PER_TILE = 11.106;
    //2.161 inches/sec
    private static final double SECONDS_PER_360_DEG = 0.0;
